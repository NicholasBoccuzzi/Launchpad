...
p1 = Project.create!(
  ...
  location: "Australia",
  deadline: DateTime.new(2018,10,07),
  creator_id: u1.id,
  category: "Games",
...
p2 = Project.create!(
  ...
  location: "Belgium",
  creator_id: u2.id,
  deadline: DateTime.new(2018,12,07),
  category: "Tech",
...
p3 = Project.create!(
  ...
  creator_id: u3.id,
  deadline: DateTime.new(2018,08,07),
  category: "Movie",
...
p4 = Project.create!(
  ...
  creator_id: u1.id,
  deadline: DateTime.new(2018,07,09),
  category: "Tech",
...
p5 = Project.create!(
  ...
  creator_id: u2.id,
  deadline: DateTime.new(2018,10,02),
  category: "Art",
...
p6 = Project.create!(
  ...
  creator_id: u1.id,
  deadline: DateTime.new(2019,02,06),
  category: "Music",
...
p8 = Project.create!(
  ...
  creator_id: u3.id,
  deadline: DateTime.new(2018,08,11),
...
p9 = Project.create!(
  ...
  deadline: DateTime.new(2018,11,09),
  creator_id: u3.id,
  category: "Food",
...
p11 = Project.create!(
  ...
  creator_id: u1.id,
  deadline: DateTime.new(2018,07,07),
  category: "Theater",
...
p13 = Project.create!(
  ...
  creator_id: u1.id,
  deadline: DateTime.new(2018,09,07),
  category: "Fashion",
